...
public class Fixtures {
	...
	private static Logger logger = Logger.getLogger(Fixtures.class);
	 ...
	 *            符合Spring Resource路径格式的文件路径列表.
	 */
	public static void reloadData(DataSource h2DataSource,
	 ...
	 *            符合Spring Resource路径格式的文件路径列表.
	 */
	public static void reloadAllTable(DataSource h2DataSource,
			String... xmlFilePaths) throws Exception {
	 ...
	 *            符合Spring Resource路径格式的文件路径列表.
	 */
	public static void deleteData(DataSource h2DataSource,
			String... xmlFilePaths) throws Exception {
	...
	private static void execute(DatabaseOperation operation,
		...
		IDatabaseConnection h2Connection = new H2Connection(
				h2DataSource.getConnection(), null);
	 ...
	 */
	public static void deleteAllTable(DataSource h2DataSource,
	 ...
	 */
	public static void deleteTable(DataSource h2DataSource,
			String... tableNames) {
