...
public class StringMapper {
	...
	public static String DATAGRAM_DATE_FORMAT = "yyyyMMdd";
	public static String DATAGRAM_DATE_TIME_FORMAT = "yyyyMMddHHmmss";
	...
	static {
		...
		StringMapper.registerDateConverter(DEFAULT_DATE_FORMAT, DEFAULT_DATETIME_FORMAT, DATAGRAM_DATE_FORMAT, DATAGRAM_DATE_TIME_FORMAT);
	}
